...
export default function Bubble({ text, className = "" }: BubbleProps) {
  return (
    <div className={`relative w-[295px] h-[176.08px] ${className} isolate`}>
      ...
      <div className="relative box-border content-stretch flex gap-2.5 items-center justify-center w-full h-full px-[74px] py-[63px]">
