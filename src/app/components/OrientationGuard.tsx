  ...
  return (
    <>
      {isInvalidOrientation && (
        <m.div className="fixed inset-0 z-102 bg-black text-white flex flex-col items-center justify-center gap-12 xl:gap-25 p-6 w-screen h-screen">
          {/* ข้อความบน */}
          ...
          <div className="w-30 md:w-50 xl:w-75">
            <LazyLottie
              src={getJsonUrl("rotate_phone.json")}
