...
export default function Scene2Gifts({ opacity, zIndex, textProgress, selectedGifts, setSelectedGifts, errorMessage }: Props) {
  ...
  <div className="flex flex-col items-center gap-5 sm:gap-6 p-3 sm:p-4 max-w-5xl text-center">
        <WordByWordAnimation text="แมว: เมื่อเสียงเรียกร้องมาถึงเจ้า… เจ้าจะเลือกมอบสิ่งใดให้โลก? จงเลือกสิ่งที่สะท้อนในใจของเจ้า" scrollYProgress={textProgress} as="p"
