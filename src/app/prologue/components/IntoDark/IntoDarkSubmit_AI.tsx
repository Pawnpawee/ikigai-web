...
export default function IntoDarkSubmit({
  ...
  // Layer 1: Background gradients (0.727-0.75)
  ...
  // Layer 4: Cat and Light Cat (0.75-0.79)
  ...
  // Layer 5: Four circles (0.76-0.82)
  ...
  // Layer 6: Ikigai diagram text (0.80-0.86)
  ...
  // Layer 7: Top explanation text (0.82-0.88)
  ...
  // Layer 8: Middle explanation text (0.84-0.90)
  ...
  // Layer 9: Bottom explanation text (0.86-0.92)
  ...
  // Layer 10: Final question text (0.90-0.95)
