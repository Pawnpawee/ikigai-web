...
export const JOB_CARDS: JobCard[] = [
  ...
  {
    id: "jc-4",
    category: "การผลิตเชื้อเพลิงชีวภาพ เคมีชีวภาพ ผลิตภัณฑ์เคมี และไบโอดีเซล",
    jobs: [
